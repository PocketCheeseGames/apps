...
@implementation SwapPowerUpMeter


- (SwapPowerUpMeter*)InitSwapPowerUpMeter
{
	[super InitPowerUp];
	...
	pPowerUpImage = 0;
	pPowerUpImage = [[DRResourceManager GetInstance] LoadTexture:@"PowerUpSwapPowerUpMeter.png"];
...
- (bool)PlayerChanges:(Player*)pPlayer
{
	...
	if( [uf isCollision:pPlayer.xPos :pPlayer.yPos :xPos :yPos :offset] )
	{
		...
		[pPlayer AddPowerUp:PU_ITEM_SWAP_PU_METER];
		available = false;
