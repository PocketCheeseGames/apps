...
@implementation Invincibility


- (Invincibility*)InitInvincibility
{
	[super InitPowerUp];
	...
	pPowerUpImage = 0;
	pPowerUpImage = [[DRResourceManager GetInstance] LoadTexture:@"PowerUpInvincible.png"];
...
- (bool)PlayerChanges:(Player*)pPlayer
{
	...
	if( [uf isCollision:pPlayer.xPos :pPlayer.yPos :xPos :yPos :offset] )
	{
		...
		[pPlayer AddPowerUp:PU_ITEM_INVINCIBLE];
		available = false;
