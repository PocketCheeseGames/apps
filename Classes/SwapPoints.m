...
@implementation SwapPoints


- (SwapPoints*)InitSwapPoints
{
	[super InitPowerUp];
	...
	pPowerUpImage = 0;
	pPowerUpImage = [[DRResourceManager GetInstance] LoadTexture:@"PowerUpSwapPoints.png"];
...
- (bool)PlayerChanges:(Player*)pPlayer
{
	...
	if( [uf isCollision:pPlayer.xPos :pPlayer.yPos :xPos :yPos :offset] )
	{
		...
		[pPlayer AddPowerUp:PU_ITEM_SWAP_POINTS];
		available = false;
